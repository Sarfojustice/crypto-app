...
const columns = [
  {
    sections: [
      {
        heading: 'Company',
        links: ['About', 'Careers', 'Affiliates', 'Blog', 'Press', 'Security', 'Investors', 'Legal & privacy', 'Cookie policy'],
      },
      {
        heading: 'Learn',
        links: ['Explore', 'Market statistics', 'Crypto basics', 'Tips & tutorials', 'Crypto glossary', 'Market updates', 'What is Bitcoin?', 'What is crypto?', 'What is a blockchain?'],
      },
    ],
  },
  {
    sections: [
      ...
      },
      {
        ...
        links: ['Prime', 'Staking', 'Exchange', 'International Exchange', 'Derivatives Exchange'],
      },
    ],
  },
  {
    sections: [
      {
        heading: 'Developers',
        links: ['Developer Platform', 'Base', 'Server Wallets', 'Embedded Wallets', 'Onramp & Offramp', 'Trade API', 'OnchainKit', 'AgentKit', 'Staking API', 'Exchange API'],
      },
    ],
  },
  {
    sections: [
      {
        heading: 'Support',
        links: ['Help center', 'Contact us', 'Create account', 'ID verification', 'Account information', 'Payment methods', 'Supported crypto'],
      },
      {
      ...
      <div className="max-w-[1440px] mx-auto px-5 lg:px-10 pt-16 pb-8">
            ...
            <div key={ci} className="flex flex-col gap-8">
              {col.sections.map((section) => (
                <div key={section.heading}>
                  <p className="text-[15px] font-bold text-gray-900 mb-3">{section.heading}</p>
                  <ul className="flex flex-col gap-2.5">
                    {section.links.map((link) => (
                      <li key={link}>
                        <a href="#" className="text-[15px] text-gray-500 hover:text-gray-800 transition-colors">
                          {link}
                        </a>
                      </li>
                    ))}
        ...
        <div className="border-t border-gray-300 pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-[14px] text-gray-500">
            ...
            <span>Global</span><span>•</span><span>English</span>
          </div>
        </div>
      </div>
    </footer>
